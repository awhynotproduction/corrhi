...
**What you get:** A structured Obsidian vault with templates, AGENTS.md instructions, and the DRC methodology.

**Includes:**
- 13 organized folders (notes, projects, sources, people, self, maps, lists, writing, capture, templates, _review, _agent)
- Note templates (atomic note, project, source, person, self, capture)
- Vault AGENTS.md (tells the agent how to work with your vault)
...
**What you get:** Everything in Tier 1, plus agent brain infrastructure and the learning loop.

**Adds:**
- Home `~/AGENTS.md` with behavioral rules
...
**Good for:** Power users who want the agent working between sessions.
